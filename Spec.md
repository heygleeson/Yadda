This document describes the specification of the ChatterScript format version 1 and guidance and rules for implementing programs who wish to process ChatterScript.
...
Commands are special statements that have no specific output to be shown to the player, but are used for controlling the flow of the story and to pass messages to other parts of the program.
